...
import shutil
# Own module
from utils.create_folder_modulized import get_folder_modulized, create_directory_folder
...
truth_folder = os.path.join(create_directory_folder, 'cINN_BP_off_FF_off')
...
def record_time():
    tk = time_keeper('random_generation_time.txt')
