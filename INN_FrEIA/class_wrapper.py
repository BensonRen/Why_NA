...
class Network(object):
    ...
    def evaluate_multiple_time(self, time=2048, save_dir='../multi_eval/INN/'):
        """
    ...
    def evaluate_modulized_multi_time(self, time=2048, algo='INN'):
        """
        ...
        for folder in folder_list:
            if algo in folder and 'cINN' not in folder:
